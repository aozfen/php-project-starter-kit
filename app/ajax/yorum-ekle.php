...
$_postId   = htmlspecialchars($_POST['txtId']);
$_yorum    = htmlspecialchars(trim($_POST['txtYorum']));
$_ad       = htmlspecialchars($_POST['txtYorumAd']);
$_mail     = htmlspecialchars($_POST['txtYorumMail']);
$_website  = htmlspecialchars($_POST['txtYorumWebSite']);
